				...
				<div class="container">
						<table style="width:50%">
							...
							<?php 
								...
								$SQL = "select kunde.id, kunde.anrede, kunde.name, kunde.vorname, kunde.notiz, mitgliedschaft.austritt from kunde left outer join mitgliedschaft on kunde.id = mitgliedschaft.kunde_id where mitgliedschaft.id is null or mitgliedschaft.austritt is not null group by kunde.id";
							...
							<tr>
								...
								<td>
									<a class="btn btn" href="neueMitgliedschaft.php?id_kunde=<?php echo $mostrar['id'];?>"><i class="fa fa-circle-o" aria-hidden="true"></i></a>
