		  ...
		  <div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav">
		      ...
		      <li class="dropdown active">
		        ...
		        <span class="caret"></span></a>
		        <ul class="dropdown-menu">
		          <li class="active"><a href="#">Sauna</a></li>
		...
		<div class="container">
			...
			<table style="width:100%">
				...
				<?php 
					...
					$SQL = "select sauna.id, sauna.beginn, sauna.laufzeit, vertrag.preis, vertrag.rabatt,kunde.id as kunde_id, kunde.name, kunde.vorname, vertrag.notiz from sauna join vertrag on sauna.id= vertrag.sauna_id join mitgliedschaft on vertrag.mitgliedschaft_id = mitgliedschaft.id join kunde on mitgliedschaft.kunde_id = kunde.id;";
				...
				<tr>
					...
					<td>&nbsp;<?php echo $mostrar['laufzeit'] ?></td>
