...
<html lang="de">
    <head>
        <title>Verträge Basistraining</title>
        <meta charset="utf-8">
    ...
    <body>
		    ...
		    <ul class="nav navbar-nav">
		      ...
		      <li class="dropdown active">
		        ...
		        <ul class="dropdown-menu">
		          ...
		          <li class="active"><a href="#" >Basistraining</a></li>
		...
		<div class="container">
			<h1>Verträge Basistraining</h1> <hr>
			<table style="width:100%">
				<tr>
					<th>&nbsp;id</th>
					<th>&nbsp;&nbsp;&nbsp;Beginn&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th>&nbsp;Mindestaufzeit</th>
				...
				<?php 
					...
					$SQL = "select basistraining.id, basistraining.beginn, basistraining.mindestlaufzeit, basistraining.kuendigungsfrist, basistraining.kuendigung, basistraining.getraenk, basistraining.angestellter_id as angestellter_id, angestellter.name, vertrag.preis, vertrag.rabatt,kunde.id as kunde_id, kunde.name as kunde_name, kunde.vorname as kunde_vorname, vertrag.notiz from basistraining join vertrag on basistraining.id= vertrag.basistraining_id join mitgliedschaft on vertrag.mitgliedschaft_id = mitgliedschaft.id join kunde on mitgliedschaft.kunde_id = kunde.id left join angestellter on basistraining.angestellter_id = angestellter.id";
				...
				<tr>
					...
					<td>&nbsp;<?php echo $mostrar['mindestlaufzeit'] ?></td>
					<td>&nbsp;<?php echo $mostrar['kuendigungsfrist'] ?></td>
					<td>&nbsp;<?php echo $mostrar['kuendigung'] ?></td>
					<td>&nbsp;<?php echo $mostrar['getraenk'] ?></td>
					...
					<td>&nbsp;<?php echo $mostrar['kunde_vorname'] ?></td>
					<td>&nbsp;<?php echo $mostrar['notiz'] ?></td>
					<td>
						<a class="btn btn" href="modVertrag.php?id=<?php echo $mostrar['id']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
					</td>
				</tr>
